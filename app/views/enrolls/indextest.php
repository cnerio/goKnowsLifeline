...
<script>
    ...
    html2canvas(document.querySelector("#enrollForm")).then(function(canvas) {
        const dataURL = canvas.toDataURL("image/png");

        $.ajax({
            url: "<?php echo URLROOT; ?>/enrolls/savescreen", // your server-side script
            type: "POST",
            data: {
                base64screen: dataURL,
                customer_id: $("#customer_id").val()
            },
            success: function(response) {
