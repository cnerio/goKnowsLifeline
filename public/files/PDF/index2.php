...
$pdf->AddPage();
$pdf->setSourceFile("templates/invoice_template.pdf"); 
...
if($type=="100004"){
	...
	$pdf->Cell(75,120);
	$pdf->Cell(35,120);
	$pdf->Cell(40,120,$total);
}else{
	$pdf->Ln(15);
	$pdf->Cell(25,90);
	$pdf->Cell(12,90,$qty);
	$pdf->Cell(80,90,"Connected Device 3");
	$pdf->Cell(35,90,"$110.99");
